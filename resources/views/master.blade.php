...
<head>
    ...
    <link href="{{ asset('/fonts/CodeNext/stylesheet.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('/fonts/Montserrat/stylesheet.css') }}" rel="stylesheet" type="text/css" />
